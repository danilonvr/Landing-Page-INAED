...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Programa de Pós Graduação em Gestão da Saúde - INAED</title>
      ...
      <main>
        <HeroSection className="px-4 pt-4 md:px-20">
          <header>
          ...
          <div className="grid grid-cols-4 md:grid-cols-8 xl:grid-cols-12 gap-4 md:gap-6">
            <div className="flex flex-col justify-center col-span-4 md:col-span-8 lg:col-span-12 2xl:col-span-5 125%:col-span-7 125%:pb-8">
              <h1 className="py-6 text-3xl 125%:text-3xl lg:text-4xl font-bold text-primaryGreen">
                Veja no que você precisa investir para ser um profissional de
                sucesso em um negócio da saúde
              </h1>
          ...
          <div className="grid grid-col-4 md:grid-cols-8 lg:grid-cols-12">
            <div className="col-span-4 md:col-span-8 lg:col-span-12 xl:col-span-6 xl:col-start-2 xl:col-end-6 2xl:flex 2xl:flex-col 2xl:justify-center">
              <p className="text-base text-lightColor leading-5 mb-4">
                Há mais de 40 anos, a Fundação Dom Cabral se destaca em seu campo de
            ...
            <div className="py-4 lg:py-6 px-4 lg:px-20 xl:max-w-xl 2xl:max-w-3xl">
              ...
              <div className="flex items-center mb-6">
                ...
                O curso será realizado na modalidade presencial, com
                  encontros em São Luís, no Maranhão.Caso tenha alguma dúvida sobre o programa, entre em contato
              ...
              <Glass
                ...
                className="hidden xl:flex xl:flex-col xl:items-center xl:justify-center xl:absolute xl:-top-20 125%:-top-24 xl:right-6"
              >
                ...
                />
                <Button href="http://mkt.inaed.com/w/7e1ne38kTegyDTh2a6h0Beddaffdb8e!uid" text="FALE COM UM ESPECIALISTA!"/>
